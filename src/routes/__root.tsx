...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Structured IELTS video courses, mock tests and daily practice across Listening, Reading, Writing and Speaking. Reach your target band with BandPath." },
      { name: "author", content: "BandPath" },
      { property: "og:title", content: "BandPath — Master IELTS with expert-led video courses" },
      { property: "og:description", content: "Structured IELTS video courses, mock tests and daily practice for every band." },
