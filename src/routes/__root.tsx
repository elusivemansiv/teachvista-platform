...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "BandPath — Master IELTS with expert-led video courses" },
      { name: "twitter:description", content: "Structured IELTS video courses across Listening, Reading, Writing and Speaking. Popular, trending and newly uploaded lessons from expert teachers." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4fa959a3-df21-4456-b72f-95ecc6bd645a/id-preview-d3ed7698--ae88b130-bacf-4bff-881a-4c030342f0b9.lovable.app-1785671335332.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4fa959a3-df21-4456-b72f-95ecc6bd645a/id-preview-d3ed7698--ae88b130-bacf-4bff-881a-4c030342f0b9.lovable.app-1785671335332.png" },
    ],
    links: [
